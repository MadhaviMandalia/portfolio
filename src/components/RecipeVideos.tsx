...
const RecipeVideos = () => {
  return (
    <section className="py-16 px-6 md:px-12 bg-chef-lightgray" id="videos">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          <Button variant="ghost" className="text-chef-terracotta hover:text-chef-coral mt-4 md:mt-0 self-start md:self-auto">
            YouTube Channel <ChevronRight className="w-4 h-4 ml-1" />
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {videos.map((video, index) => (
            ...
            >
              <div className="relative h-56 md:h-64 overflow-hidden rounded-xl mb-4">
                <img 
                  src={video.thumbnail} 
                  alt={video.title} 
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform cursor-pointer">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-chef-terracotta flex items-center justify-center">
              ...
              <div className="flex justify-between items-center">
                <span className="text-chef-charcoal/70 text-sm">
                  {video.views} views
                </span>
                <Button 
                  variant="ghost" 
