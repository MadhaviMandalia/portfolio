...
const BentoGrid = () => {
  return (
    <section className="py-16 px-6 md:px-12 bg-chef-lightgray" id="about">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6 auto-rows-minmax(100px, auto)">
          {/* About Card - Large */}
          <div className="col-span-1 md:col-span-2 lg:col-span-3 row-span-2 bento-card group animate-scale-in" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-3 row-span-2 bento-card overflow-hidden group animate-scale-in" style={{ animationDelay: "0.2s" }}>
          ...
          {/* Stats Card */}
          <div className="col-span-1 md:col-span-2 row-span-1 bento-card bg-gradient-to-br from-chef-terracotta to-chef-coral animate-scale-in" style={{ animationDelay: "0.3s" }}>
          ...
          {/* Awards Card */}
          <div className="col-span-1 md:col-span-2 row-span-1 bento-card animate-scale-in flex flex-col justify-center" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-2 row-span-1 bento-card group overflow-hidden animate-scale-in" style={{ animationDelay: "0.5s" }}>
            <div className="relative h-full">
              <img 
          ...
          {/* YouTube Link */}
          <div className="col-span-1 md:col-span-1 lg:col-span-2 row-span-1 bento-card bg-chef-sage/20 group hover:bg-chef-sage/30 transition-colors animate-scale-in" style={{ animationDelay: "0.6s" }}>
          ...
          {/* Cooking Philosophy */}
          <div className="col-span-1 md:col-span-2 row-span-1 bento-card border-chef-saffron animate-scale-in" style={{ animationDelay: "0.7s" }}>
